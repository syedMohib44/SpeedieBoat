...
{
    public class CheatJumpPlayerAction : JumpPlayerAction
    {
        ...
        public CheatJumpPlayerAction(Player player, PlayerActionInitialiser initialiser)
        ...
        {
            get { return ((CheatJumpPlayerActionInitialiser)m_initialiser).JumpHeight; }
        }
        ...
        {
            get { return ((CheatJumpPlayerActionInitialiser)m_initialiser).JumpTime; }
        }
        ...
        {
            get { return ((CheatJumpPlayerActionInitialiser)m_initialiser).JumpBounces; }
        }
        ...
        {
            get { return ((CheatJumpPlayerActionInitialiser)m_initialiser).LaunchAngle; }
        }
        ...
        {
            get { return ((CheatJumpPlayerActionInitialiser)m_initialiser).LandPos; }
        }
